...
import { _ as _export_sfc, u as useRouteLocale, e as useLocale, f as useSearchIndex, w as withBase } from "../app.4EfO4HGo.mjs";
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    debouncedWatch(
      ...
      async ([index, filterTextValue], old, onCleanup) => {
        ...
        if (!index)
          return;
        results.value = index.search(filterTextValue);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ssrRenderTeleport(_push, (_push2) => {
    ...
    _push2(`<div role="button"${ssrRenderAttr("aria-owns", ((_a = $setup.results) == null ? void 0 : _a.length) ? "localsearch-list" : void 0)} aria-expanded="true" aria-haspopup="listbox" aria-labelledby="mini-search-label" class="VPLocalSearchBox" data-v-d6af2f6c><div class="backdrop" data-v-d6af2f6c></div><div class="shell" data-v-d6af2f6c><form class="search-bar" data-v-d6af2f6c><label id="localsearch-label"${ssrRenderAttr("title", $setup.buttonText)} for="localsearch-input" data-v-d6af2f6c>`);
    _push2(ssrRenderComponent($setup["SearchIcon"], { class: "search-icon" }, null, _parent));
    _push2(`</label><div class="search-actions before" data-v-d6af2f6c><button class="back-button"${ssrRenderAttr("title", $setup.locale.backButtonTitle)} data-v-d6af2f6c>`);
    _push2(ssrRenderComponent($setup["BackIcon"], null, null, _parent));
    _push2(`</button></div><input id="localsearch-input"${ssrRenderAttr("value", $setup.filterText)}${ssrRenderAttr("placeholder", $setup.buttonText)} aria-labelledby="localsearch-label" class="search-input" data-v-d6af2f6c><div class="search-actions" data-v-d6af2f6c><button class="clear-button" type="reset"${ssrIncludeBooleanAttr($setup.disableReset) ? " disabled" : ""}${ssrRenderAttr("title", $setup.locale.resetButtonTitle)} data-v-d6af2f6c>`);
    _push2(ssrRenderComponent($setup["ClearIcon"], null, null, _parent));
    _push2(`</button></div></form><ul${ssrRenderAttr("id", ((_b = $setup.results) == null ? void 0 : _b.length) ? "localsearch-list" : void 0)}${ssrRenderAttr("role", ((_c = $setup.results) == null ? void 0 : _c.length) ? "listbox" : void 0)}${ssrRenderAttr("aria-labelledby", ((_d = $setup.results) == null ? void 0 : _d.length) ? "localsearch-label" : void 0)} class="results" data-v-d6af2f6c><!--[-->`);
    ssrRenderList($setup.results, (p, index) => {
      _push2(`<li role="option"${ssrRenderAttr("aria-selected", $setup.selectedIndex === index ? "true" : "false")} data-v-d6af2f6c><a${ssrRenderAttr("href", $setup.withBase(p.id))} class="${ssrRenderClass([{
        selected: $setup.selectedIndex === index
      }, "result"])}"${ssrRenderAttr("aria-label", [...p.titles, p.title].join(" > "))} data-v-d6af2f6c><div data-v-d6af2f6c><div class="titles" data-v-d6af2f6c><span class="title-icon" data-v-d6af2f6c>#</span><!--[-->`);
      ssrRenderList(p.titles, (t, i) => {
        _push2(`<span class="title" data-v-d6af2f6c><span class="text" data-v-d6af2f6c>${t ?? ""}</span><svg width="18" height="18" viewBox="0 0 24 24" data-v-d6af2f6c><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m9 18l6-6l-6-6" data-v-d6af2f6c></path></svg></span>`);
      });
      _push2(`<!--]--><span class="title main" data-v-d6af2f6c><span class="text" data-v-d6af2f6c>${p.title ?? ""}</span></span></div></div></a></li>`);
    });
    _push2(`<!--]-->`);
    if ($setup.filterText && !$setup.results.length && $setup.enableNoResults) {
      _push2(`<li class="no-results" data-v-d6af2f6c>${ssrInterpolate($setup.locale.noResultsText)} &quot;<strong data-v-d6af2f6c>${ssrInterpolate($setup.filterText)}</strong>&quot; </li>`);
    } else {
      _push2(`<!---->`);
    }
    _push2(`</ul><div class="search-keyboard-shortcuts" data-v-d6af2f6c><span data-v-d6af2f6c><kbd${ssrRenderAttr("aria-label", ((_e = $setup.locale.footer) == null ? void 0 : _e.navigateUpKeyAriaLabel) ?? "")} data-v-d6af2f6c><svg width="14" height="14" viewBox="0 0 24 24" data-v-d6af2f6c><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19V5m-7 7l7-7l7 7" data-v-d6af2f6c></path></svg></kbd><kbd${ssrRenderAttr("aria-label", ((_f = $setup.locale.footer) == null ? void 0 : _f.navigateDownKeyAriaLabel) ?? "")} data-v-d6af2f6c><svg width="14" height="14" viewBox="0 0 24 24" data-v-d6af2f6c><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v14m7-7l-7 7l-7-7" data-v-d6af2f6c></path></svg></kbd> ${ssrInterpolate(((_g = $setup.locale.footer) == null ? void 0 : _g.navigateText) ?? "")}</span><span data-v-d6af2f6c><kbd${ssrRenderAttr("aria-label", ((_h = $setup.locale.footer) == null ? void 0 : _h.selectKeyAriaLabel) ?? "")} data-v-d6af2f6c><svg width="14" height="14" viewBox="0 0 24 24" data-v-d6af2f6c><g fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" data-v-d6af2f6c><path d="m9 10l-5 5l5 5" data-v-d6af2f6c></path><path d="M20 4v7a4 4 0 0 1-4 4H4" data-v-d6af2f6c></path></g></svg></kbd> ${ssrInterpolate(((_i = $setup.locale.footer) == null ? void 0 : _i.selectText) ?? "")}</span><span data-v-d6af2f6c><kbd${ssrRenderAttr("aria-label", ((_j = $setup.locale.footer) == null ? void 0 : _j.closeKeyAriaLabel) ?? "")} data-v-d6af2f6c>esc</kbd> ${ssrInterpolate(((_k = $setup.locale.footer) == null ? void 0 : _k.closeText) ?? "")}</span></div></div></div>`);
  }, "body", false, _parent);
}
...
const SearchBox = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-d6af2f6c"], ["__file", "SearchBox.vue"]]);
export {
